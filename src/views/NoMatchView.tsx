            ...
            <div className="misc-wrapper">
                ...
                <div className="mt-3">
                    <img
                        ...
                        width="500"
                        className="img-fluid"
                        data-app-dark-img={process.env.PUBLIC_URL + '/assets/img/illustrations/page-misc-error-dark.png'}
                        data-app-light-img={process.env.PUBLIC_URL + '/assets/img/illustrations/page-misc-error-light.png'}
                    />
                </div>
            </div>
        </div>
